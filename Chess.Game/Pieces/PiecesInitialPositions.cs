...
namespace Chess.Game.Pieces.Positions
{
    ...
    {
        public static readonly Vector2 WHITE_ROOK_1 = new Vector2(0, 0);
        public static readonly Vector2 WHITE_KNIGHT_1 = new Vector2(1, 0);
        public static readonly Vector2 WHITE_BISHOP_1 = new Vector2(2, 0);
        public static readonly Vector2 WHITE_QUEEN = new Vector2(3, 0);
        public static readonly Vector2 WHITE_KING = new Vector2(4, 0);
        public static readonly Vector2 WHITE_BISHOP_2 = new Vector2(5, 0);
        public static readonly Vector2 WHITE_KNIGHT_2 = new Vector2(6, 0);
        public static readonly Vector2 WHITE_ROOK_2 = new Vector2(7, 0);

        public static readonly Vector2[] WHITE_PAWNS =
        {
            new Vector2(0, 1), new Vector2(1, 1), new Vector2(2, 1), new Vector2(3, 1),
            new Vector2(4, 1), new Vector2(5, 1), new Vector2(6, 1), new Vector2(7, 1)
        };

        public static readonly Vector2 BLACK_ROOK_1 = new Vector2(0, 7);
        public static readonly Vector2 BLACK_KNIGHT_1 = new Vector2(1, 7);
        public static readonly Vector2 BLACK_BISHOP_1 = new Vector2(2, 7);
        public static readonly Vector2 BLACK_QUEEN = new Vector2(3, 7);
        public static readonly Vector2 BLACK_KING = new Vector2(4, 7);
        public static readonly Vector2 BLACK_BISHOP_2 = new Vector2(5, 7);
        public static readonly Vector2 BLACK_KNIGHT_2 = new Vector2(6, 7);
        public static readonly Vector2 BLACK_ROOK_2 = new Vector2(7, 7);

        public static readonly Vector2[] BLACK_PAWNS =
        {
        ...
        public static IEnumerable<(Type PieceType, PieceColour Colour, Vector2 Position)> GetAllPieces()
        {
